export default function Contact() {
    return (
      <div>
          <div className=" md:mb-18 mb-10 md:h-[60vh] h-[40vh] z-5 items-center justify-center  w-screen bg-[url('/images/road.jpg')] bg-cover bg-center  text-white ">
        <div className="flex w-full absolute items-center justify-center bg-gray-950/60 md:h-[60vh] h-[40vh] ">
          <div className="text-center justify-center items-center">
            <h1 className="flex text-center items-center justify-center uppercase font-bold md:text-[60px]">Countact</h1>    
          </div>
        </div>
      </div>
          ...
          <div className="w-screen h-auto  mb-12">
                  <div className="justify-center items-center text-center w-auto">
                      <h1 className="text-3xl font-extrabold ">Countact Us</h1>
                      <p className="md:text-xl  text-center mx-2 md:mx-60">Where peculiarity of project demands, we work in association 
with reputable specialist companies within Nigeria and also in 
Europe and the United States of America</p>
              </div>
          </div>
...
<section  className="mb-32 text-gray-800">
  ...
  <div  className="block rounded-lg shadow-lg bg-white">
    <div  className="flex flex-wrap items-center">
      <div  className="grow-0 shrink-0 basis-auto block w-full lg:flex h-[300px] lg:w-6/12 xl:w-4/12">
        <div  className="map-container-2 w-full">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.6579451919283!2d7.468841874135447!3d9.003587789388034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0dbb19e6d2ef%3A0x2129092e8b66a8ca!2sAdisa%20Plaza!5e0!3m2!1sen!2sng!4v1683126892577!5m2!1sen!2sng" className="border-4 md:w-[450px] h-[250px] w-[350px]"   loading="lazy"></iframe>
        </div>
      </div>
        ...
        <div  className="flex flex-wrap pt-12 lg:pt-0">
          <div  className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
            <div  className="flex items-start">
              ...
              <div  className="grow ml-6">
                <p  className="font-bold mb-1">Help Desk</p>
          ...
          <div  className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
            <div  className="flex align-start">
              ...
              <div  className="grow ml-6">
                <p  className="font-bold mb-1">Branch Offices</p>
